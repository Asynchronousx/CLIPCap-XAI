## CLIP-Captioner with Grad-CAM Explainability (Master Thesis)
...
![Source image](media/source_img.jpg)

![Combined Grad-CAM overlay](media/combined_plot.png)

![Individual 0](media/individual_plot_0.png)
![Individual 1](media/individual_plot_1.png)
![Individual 2](media/individual_plot_2.png)
![Individual 3](media/individual_plot_3.png)
![Individual 4](media/individual_plot_4.png)

## Video demo

Short demo of the Gradio app flow (placeholder):

- File: `media/supplychain_example.mp4`
- If GitHub preview is not available in your environment, download and open locally.

Link:

`media/supplychain_example.mp4`

HTML fallback (may not render on all platforms):

<video src="media/supplychain_example.mp4" controls width="640"></video>
